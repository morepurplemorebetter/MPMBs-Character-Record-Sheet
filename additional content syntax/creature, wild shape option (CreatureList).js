...
*/
	...
	actions: [{
		...
		addMod: [{
			...
			field: "all",
			mod: "max(oCha|1)",
			text: "The purple crawler adds its master's Charisma modifier (min 1) to all its skill checks.",
		}],
	}],
	traits: [{
		name: "Keen Sight",
...
*/
	addMod: [{
		...
		field: "Init",
		mod: "Int",
		text: "The purple crawler adds its Intelligence modifier to initiative rolls.",
	},
	{
		type: "save",
		field: "all",
