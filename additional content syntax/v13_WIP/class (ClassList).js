/*	-WHAT IS THIS?-
	...
	-HOW TO READ-
	Every line comes with a comment immediately after it to show it is // Optional // or // Required //
	Below the line is a more explanatory comment

	-THIS IS JAVASCRIPT-
	The imports scripts work by creating new objects inside object and by calling functions.
	...
	Multiline comments are possible. Open them using the forward slash followed by an asterisk and close them with the opposite (see the top line and the line below this one).
