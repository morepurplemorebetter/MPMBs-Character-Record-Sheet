...
var Base_MagicItemsList = {
	...
	"potion of invisibility": {
		...
		rarity: "very rare",
		magicItemTable: "D",
		description: "Once as an action, I can drink this potion or administer it to another to become invisible for 1 hour. Anything the consumer wears or carries is invisible along with it. The effect ends early if the consumer attacks or casts a spell. This potion's container looks empty but feels as though it holds liquid.",
	...
	"ring of djinni summoning": {
		...
		rarity: "legendary",
		magicItemTable: "I",
		description: "As an action, I can speak this ring's command word to summon a djinni within 120 ft, remaining while I concentrate, up to 1 hour. After that time, I can't summon it for 24 hours. It is friendly to me and my allies, obeys my commands, but takes no actions if not commanded to. The ring loses its magic if the djinni dies.",
	...
	"rod of lordly might": {
		...
		calcChanges: {
			atkAdd: [
				...
				'If I include the words "Lordly Might" in the name of a sword, it will be treated as the magic weapon Flame Tongue (the effect of pressing the 1st button of the Rod of Lordly Might). It adds +2d6 fire damage on a hit and shines light.',
			],
		},
	},
	"rod of rulership": {
