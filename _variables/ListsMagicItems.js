...
var Base_MagicItemsList = {
	...
	"rope of climbing" : {
		...
		rarity : "uncommon",
		magicItemTable : "B",
		description : "This 60-ft silk rope can hold 3000 lb, has AC 20, 20 HP, and heals 1 HP/5 min. As an action while I hold one end, I can animate it with its command word. Then, as a bonus action, I can command its other end to move (10 ft on my turn). I can also tell it to coil, (un)fasten, or (un)knot (50-ft length, adv. to climb it).",
		descriptionLong : "This 60-ft silk rope can hold up to 3000 lb, has AC 20, 20 HP, regains 1 HP per 5 minutes, and is destroyed if it drops to 0 HP. As an action while holding one end of the rope, I can speak the command word to animate it. Then, as a bonus action, I can command the other end to move 10 ft to a chosen destination up to its maximum length away, moving 10 ft on each of my turns until it reaches it. I can also tell it to stop moving, to fasten itself securely, to unfasten itself, to knot or unknot itself, or to coil itself for carrying. While knotted, the rope shortens to 50 ft and grants advantage to climb it.",
	...
	"rope of entanglement" : {
		...
		weaponOptions : [{
			...
			range : "20 ft",
			description : "DC 15 Strength or Dexterity check to escape",
			abilitytodamage : false,
			weight : 3,
			modifiers : [7, 0],
			dc : true,
