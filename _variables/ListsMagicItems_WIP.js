var Base_MagicItemsList = {
	...
	"ring of shooting stars" : { // finished
		...
		spellChanges : {
			...
			"magic missile" : { // change into Shooting Stars
				...
				description : "15-ft cube in range per expended charge; all in the cubes 5d4 Fire damage, save halves",
	...
	"ring of spell turning" : { // finished
	...
	"talisman of the sphere" : { // finished
	...
	"wand of enemy detection" : { // finished
	...
	"wand of lightning bolts" : { // finished
	...
	"wand of magic missiles" : { // finished
	...
	"wand of the war mage, +1, +2, or +3" : { // finished
