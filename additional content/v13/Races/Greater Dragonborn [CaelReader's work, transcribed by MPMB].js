...
AddRacialVariant("greater dragonborn", "black", {
	...
	trait : [
		...
		"Acid Breath Weapon: As an action once per short rest, I can deal 2d6 acid damage to all in a 5 ft by 30 ft line, Dex save halves (DC 8 + Dex mod + prof bonus). This damage increases with 1d6 at level 5, 11, and 17.",
		"Brutal and Cruel: I add your Constitution modifier to the damage of my breath weapon.",
		"Natural Armor: I have an AC of 13 + Dexterity modifier + shield."
	].join("\n"),
	dmgres : ["Acid"]
});
AddRacialVariant("greater dragonborn", "blue", {
	...
	trait : [
		...
		"Lightning Breath Weapon: As an action once per short rest, I can deal 2d6 lightning damage to all in a 5 ft by 30 ft line, Dex save halves (DC 8 + Dex mod + prof bonus). This damage increases with 1d6 at level 5, 11, and 17.",
...
AddRacialVariant("greater dragonborn", "brass", {
	...
	trait : [
		...
		"Fire Breath Weapon: As an action once per short rest, I can deal 2d6 fire damage to all in a 5 ft by 30 ft line, Dex save halves (DC 8 + Dex mod + prof bonus). This damage increases with 1d6 at level 5, 11, and 17.",
...
AddRacialVariant("greater dragonborn", "gold", {
	...
	trait : [
		...
		"Fire Breath Weapon: As an action once per short rest, I can deal 2d6 fire damage to all in a 15 ft cone, Dex save halves (DC 8 + Dex mod + prof bonus). This damage increases with 1d6 at level 5, 11, and 17.",
...
AddRacialVariant("greater dragonborn", "green", {
	...
	trait : [
		...
		"Poison Breath Weapon: As an action once per short rest, I can deal 2d6 poison damage to all in a 15 ft cone, Dex save halves (DC 8 + Con mod + prof bonus). This damage increases with 1d6 at level 5, 11, and 17.",
...
AddRacialVariant("greater dragonborn", "silver", {
	...
	trait : [
		...
		"Cold Breath Weapon: As an action once per short rest, I can deal 2d6 cold damage to all in a 15 ft cone, Dex save halves (DC 8 + Con mod + prof bonus). This damage increases with 1d6 at level 5, 11, and 17.",
