...
AddSubClass("bard", "college of mourning", {
	...
	features : {
		"subclassfeature3" : {
			...
			source : ["HB", 0],
			minlevel : 3,
			description: desc("I gain proficiency with one instrument of my choice. Also add my proficiency bonus to Death Saves. ")
		},
		"subclassfeature3.1" : {
			name : "Dead Man's Tongue",
			source : ["HB", 0],
			minlevel : 3,
			description: desc("I learn the Speak with Dead spell and can cast it at will a number of times equal to my Charisma modifier per long rest.")
		},
		"subclassfeature3.2" : {
			name : "Haunting Melody",
			source : ["HB", 0],
			minlevel : 3,
			description: desc("I learn to use music to inspire fear. An enemy within 60ft makes a WIS save vs my spell casting DC. I can expend a bardic inspiration dir to lower their save by the number rolled. As long as I maintain concentration, the target cannot willingly move within 30 ft. of me. Must finish a long rest to regain this feature."),
			action : [["action", ""]]
		},
		"subclassfeature6" : {
		...
		"subclassfeature14" : {
			...
			source : ["HB", 0],
			minlevel : 14,
			description: desc("My talent is so great the dead stop to acknowledge my skill. When I use Countercharm, hostile undead within range have disadvantage on attacks and saves."),
