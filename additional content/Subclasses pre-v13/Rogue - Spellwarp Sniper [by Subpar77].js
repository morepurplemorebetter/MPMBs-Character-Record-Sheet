...
AddSubClass("rogue", "spellwarp sniper", {
	...
	features : {
		"subclassfeature3" : {
			...
			source : ["HB", 0],
			minlevel : 3,
			description: desc("I can cast known Sorcerer cantrips/spells, using Charisma as my spell casting ability."),
		...
		"subclassfeature3.1" : {
			...
			source : ["HB", 0],
			minlevel : 3,
			description: desc("I can bend any area effect spell into a ray. My rays count as precision damage and may have sneak attack die added if sneak attack would apply.")
		},
		"subclassfeature9" : {
			name : "Forceful Rays",
			source : ["HB", 0],
			minlevel : 9,
			description: desc("Empower Spell as though using sorcerer metamagic."),
			recovery : "long rest",
			usages : 2
		},
		"sublcassfeature9.1" : {
		...
		"subclassfeature17" : {
			...
			description: desc([
				...
				"Damage is rerolled. Requires concentration.",
			]),
		}
	}
});
