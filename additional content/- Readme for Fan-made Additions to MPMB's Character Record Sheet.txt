...
Note that a lot of the "Unearthed Arcana" material is gone as fromfrom v12.7 onwards, it is integrated in the sheet directly. You can add these materials by using the "Sources" button.
